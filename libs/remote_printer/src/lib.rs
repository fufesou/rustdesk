...
const RD_PRINTER_PORT: PCWSTR = w!("RustDesk Printer");
const RD_PRINTER_NAME: PCWSTR = w!("RustDesk Printer");
const RD_PRINTER_DRIVER_NAME: PCWSTR = w!("RustDesk v4 Printer Driver");

#[inline]
pub fn is_rd_printer_installed() -> ResultType<bool> {
