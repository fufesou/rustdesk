...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Printer", "打印机"),
        ("printer-requires-installed-client-tip", "请先安装 RustDesk 客户端。"),
        ("printer-driver-not-installed-tip", "未安装 RustDesk 打印机。"),
        ("printer-driver-installed-tip", "RustDesk 打印机已安装，您可以使用打印功能了。"),
        ("Install RustDesk Printer", "安装 RustDesk 打印机"),
