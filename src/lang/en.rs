...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("terminal-clipboard-write-tip", "A terminal application tried to copy text to your local clipboard. This setting applies to all terminal connections. Manual copy and paste are unaffected."),
    ].iter().cloned().collect();
}
