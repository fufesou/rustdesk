...
// Update check policy:
// - Windows installed (including custom client): always check for updates
// - Non-custom client on any platform: check for updates
// - Custom client on non-Windows or Windows portable: skip update check
