...
pub mod client {
    ...
    fn high_resolution_axis_options(x: i32, y: i32) -> arg::PropMap {
    ...
    #[cfg(test)]
    mod tests {
        use super::{desktop_is_niri, high_resolution_axis_delta, high_resolution_axis_options};
        ...
        fn marks_zero_delta_as_scroll_sequence_end() {
            let finish_options = high_resolution_axis_options(0, 0);
            let scroll_options = high_resolution_axis_options(1, 0);
    ...
    impl MouseControllable for RdpInputMouse {
        ...
        fn mouse_scroll_high_resolution(&mut self, x: i32, y: i32) -> enigo::ResultType {
            ...
            remote_desktop_portal::notify_pointer_axis(
                &portal,
                &self.session,
                high_resolution_axis_options(x, y),
