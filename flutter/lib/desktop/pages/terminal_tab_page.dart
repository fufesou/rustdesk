...
class _TerminalTabPageState extends State<TerminalTabPage> {
  ...
  void _showTerminalClipboardNotice() {
    final request =
        _terminalClipboardNotice.startShowing(_canWriteTerminalClipboard);
  ...
  void _handleTerminalClipboardNoticeClosed() {
    ...
    if (hasNext) _showTerminalClipboardNotice();
  }
  ...
  void _closeTerminalClipboardNotice({
    TerminalClipboardNoticeRequest<_TerminalClipboardSource>? expected,
  }) {
