...
TEST_WORKFLOW = (
    SCRIPT.parents[1] / ".github/workflows/complete-test-update-release.yml"
...
class UpdateMetadataCliTests(unittest.TestCase):
    ...
    def test_fixed_test_workflow_passes_test_release_identity(self):
        self.assertEqual(2, TEST_WORKFLOW.count("--package-id rustdesk"))
        self.assertEqual(
            2,
            TEST_WORKFLOW.count(
                '--release-base-url "https://github.com/${TARGET_REPOSITORY}/releases/download"'
            ),
        )
